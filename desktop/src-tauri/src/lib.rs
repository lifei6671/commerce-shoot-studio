...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::ai_assist::ai_assist_recognize_image_text,
            ...
            commands::generation::generation_delete_result_image,
            ...
            commands::generation::generation_replace_result_image,
            commands::generation::generation_run_next_task,
            commands::generation::generation_run_task,
            ...
            commands::model_config::model_config_list_image_size_options,
            ...
            commands::prompt_plan::prompt_plan_create,
