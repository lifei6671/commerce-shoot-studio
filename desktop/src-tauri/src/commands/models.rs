...
use crate::services::model_validator::{
    get_model_config_by_id, list_model_definitions as list_definitions,
    save_model_config_request,
};
use crate::state::AppState;

#[tauri::command]
pub async fn list_model_definitions(advanced_models: Option<bool>) -> AppResult<Vec<ModelDefinition>> {
...
pub async fn save_model_config(
    ...
    save_model_config_request(
        state.database(),
        request,
        advanced_models.unwrap_or(false),
    )
    .await
}
